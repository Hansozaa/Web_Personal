...
?>
<!DOCTYPE html>
<html lang="id" class="scroll-smooth transition duration-300">
<head>
    <meta charset="UTF-8">
    ...
    <header class="bg-white dark:bg-slate-800 shadow-lg sticky top-0 z-40 border-b border-slate-200 dark:border-slate-700">
        <div class="container mx-auto px-4 flex justify-between items-center py-4">
            <div class="flex items-center">
                ...
                <div>
                    <h1 class="text-xl md:text-2xl font-bold">Tambah Project Terbaru</h1>
                    <p class="text-gray-600 dark:text-slate-400 text-sm">Tambahkan Project Baru Ke Daftar Project</p>
                </div>
            </div>
            <div class="flex items-center">
        ...
        <main class="w-full md:w-3/4">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                <div class="mb-3 md:mb-0">
                    <h2 class="text-xl md:text-2xl font-bold text-slate-800 dark:text-white">Form Tambah Project</h2>
                    <p class="text-slate-600 dark:text-slate-400 text-sm">Isi detail project</p>
                </div>
            ...
            <div class="bg-white dark:bg-slate-800 rounded-lg shadow-lg overflow-hidden card-3d p-6">
                <form action="proses_add_gallery.php" method="post" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div>
                        ...
                        <div id="preview-container" class="preview-container mt-4">
                            <p class="text-sm font-medium text-slate-700 dark:text-slate-300 mb-2">Pratinjau Gambar:</p>
